...
$host = "localhost";
$username = "root";
$password = "Haji"; // Add your database password if needed
$database = "Qb";
...
function getApplications($conn, $category) {
    $stmt = $conn->prepare("SELECT `name`, `username`, `jobcategory`, `gender`, `jobtype` FROM `mytable` WHERE `jobcategory` = ?");
...
<br>
<!--Footer started-->
<footer style="background-color: #98fb98; color: black; padding: 20px; text-align: center;">
        <div class="container">
            <div class="row">
                <div class="col">
                    <h5>About Us</h5>
